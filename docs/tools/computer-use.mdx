---
title: Computer use
description: The model drives a screen — clicks, types, and reads screenshots. Tested on OpenAI, Anthropic, Google, Azure, and OpenRouter vision models.
index: 4
---
...
| [`openRouterClientAdapter`](/docs/adapters/client-adapters/openrouter) + [`completionsRunAdapter`](/docs/adapters/run-adapters/completions) | `{ type: 'computer_use_preview', computer_use_preview: {...} }` (Assistants API) | GLM, Qwen-VL, Kimi-VL, Gemini Flash via OpenRouter |
