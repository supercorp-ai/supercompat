...
import type { RunStepOutput } from '@azure/ai-projects'
import type OpenAI from 'openai'

export const serializeRunStep = ({
  runStep,
}: {
  runStep: RunStepOutput
}) => ({
  id: runStep.id,
  ...
  type: runStep.type as OpenAI.Beta.Threads.Runs.RunStep['type'],
  status: runStep.status as OpenAI.Beta.Threads.Runs.RunStep['status'],
