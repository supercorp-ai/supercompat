...
// =========================================================================
test('openRouter Qwen: basic chat completion', async () => {
...
// =========================================================================
test('openRouter Qwen: streaming chat completion', async () => {
  const client = supercompat({
    client: openRouterClientAdapter({ openRouter: makeOpenRouter() }),
  })
...
// =========================================================================
test('openRouter Qwen: tool calling', async () => {
  const client = supercompat({
    client: openRouterClientAdapter({ openRouter: makeOpenRouter() }),
  })
...
// =========================================================================
test('openRouter Qwen: thread/run via completionsRunAdapter', async () => {
...
// =========================================================================
test('openRouter Qwen: thread/run with tool calling', async () => {
  const prisma = new PrismaClient()
...
// 6. Models list
// =========================================================================
test('openRouter Qwen: models list', async () => {
  const client = supercompat({
    client: openRouterClientAdapter({ openRouter: makeOpenRouter() }),
  })
