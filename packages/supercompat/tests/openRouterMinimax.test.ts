...
// =========================================================================
test('openRouter MiniMax: basic chat completion', async () => {
...
// =========================================================================
test('openRouter MiniMax: streaming chat completion', async () => {
  const client = supercompat({
    client: openRouterClientAdapter({ openRouter: makeOpenRouter() }),
  })
...
// =========================================================================
test('openRouter MiniMax: tool calling', async () => {
  const client = supercompat({
    client: openRouterClientAdapter({ openRouter: makeOpenRouter() }),
  })
...
// =========================================================================
test('openRouter MiniMax: thread/run via completionsRunAdapter', async () => {
...
// =========================================================================
test('openRouter MiniMax: thread/run with tool calling', async () => {
  const prisma = new PrismaClient()
...
// 6. Models list
// =========================================================================
test('openRouter MiniMax: models list', async () => {
  const client = supercompat({
    client: openRouterClientAdapter({ openRouter: makeOpenRouter() }),
  })
