...
// =========================================================================
test('openRouter GLM: basic chat completion', async () => {
...
// =========================================================================
test('openRouter GLM: streaming chat completion', async () => {
  const client = supercompat({
    client: openRouterClientAdapter({ openRouter: makeOpenRouter() }),
  })
...
// =========================================================================
test('openRouter GLM: tool calling', async () => {
  const client = supercompat({
    client: openRouterClientAdapter({ openRouter: makeOpenRouter() }),
  })
...
// =========================================================================
test('openRouter GLM: thread/run via completionsRunAdapter', async () => {
...
// =========================================================================
test('openRouter GLM: thread/run with tool calling', async () => {
  const prisma = new PrismaClient()
...
// 6. Models list
// =========================================================================
test('openRouter GLM: models list', async () => {
  const client = supercompat({
    client: openRouterClientAdapter({ openRouter: makeOpenRouter() }),
  })
